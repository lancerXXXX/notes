...
佩亚诺余项泰勒展开式比用等价无穷小替换更精细
    ...
    > $$
    > \begin{aligned}
    > \lim_{x\rightarrow 0}\frac{(1+x)^{-\frac{1}{x^3}}}{x}&=\lim_{x\rightarrow 0}\frac{\frac{1}{x}}{(1+x)^{\frac{1}{x^3}}}
    > \\&\overset{洛}{=}\lim_{x\rightarrow 0}\frac{-\frac{1}{x^2}}{(1+x)^{\frac{1}{x^3}}[\frac{1}{(1+x)x^3}-\frac{3\ln (1+x)}{x^{4}}]}
    > \\&\overset{化简}{=} \lim_{x\rightarrow 0}(1+x)^{\frac{1}{x^3}}[\frac{-x^2(1+x)}{1-3(1+x)\frac{\ln (1+x)}{x}}]=0\times \frac{0}{2}
    > \end{aligned}
    > $$
    > 例 $\frac{0}{0}$
    $$
    \begin{aligned}
    \lim_{x\rightarrow 0} \frac{x-\ln (1+x)(1+x)}{(1+x)x^2}=&\lim_{x\rightarrow 0} \frac{x-\ln (1+x)(1+x)}{x^2+x^3}\\
    \overset{洛}{=} &\lim_{x\rightarrow 0}\frac{1-1-\ln (1+x)}{2x+3x^2}\\
    \overset{洛}{=} &\lim_{x\rightarrow 0}\frac{1}{(1+x)(2+6x)}=\frac{1}{2}
    \end{aligned}
    $$
2.  $\infty -\infty$
