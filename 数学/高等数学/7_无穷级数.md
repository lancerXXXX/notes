...
- 交错级数 $∑\limits_{n=1}^{∞}(-1)^{n-1}u_{n}~~~~_{u_{n}>0}$ 
  - 莱布尼兹判别准则 
    - 单减趋于零 $u_{n}⩾u_{n+1}\ _{n=1,2,\cdots}∧ \lim\limits_{n \to ∞}u_{n}=0⇒收敛$  
...
- 运算法则
  - $∑\limits_{n=0}^{∞}a_{n}x^{n}: R_{a}~~~~∑\limits_{n=0}^{∞}b_{n}x^n: R_{b}$
    ...
    - $∑\limits_{n=n_0}^{∞}a_{n}x^n±∑\limits_{n=n_0}^{∞}b_{n}x^n=∑\limits_{n=n_0}^{∞}(a_{n}±b_{n})x^n, |x|<R=\min\{R_{a},R_{b}\}$
      - 变换
        - 通项,下标一起变 $∑\limits_{n=k}^{∞}a_{n}x^n=∑\limits_{n=k+l}^{∞}a_{n-l}x^{n-l}$
        - 只变下标,不变通项  
          $∑\limits_{n=k}^{∞}a_nx^{n}=a_{k}x^{k}+\cdots+a_{k+l-1}x^{k+l-1}+∑\limits_{n=k+1}^{∞}a_nx^{n}$
        - 只变通项,不变下标 $∑\limits_{n=k}^{∞}a_nx^{n}=x^{l}∑\limits_{n=k}^{∞}a_nx^{n-l}$
- 常用麦克劳林展开式
  - $\frac{1}{1-x}  = 1+x+x^{2}+\cdots+x^{n}+\cdots, x \in(-1,1)$ $~~\frac{首项}{1-公比}~~|公比|<1$
  - $\frac{1}{1+x}  = 1-x+x^{2}+\cdots+(-1)^{n} x^{n}+\cdots, x \in(-1,1)$
  - $\mathrm{e}^{x}  = 1+x+\frac{x^{2}}{2 !}+\cdots+\frac{x^{n}}{n !}+\cdots, x \in(-∞,+∞)$
  - $\mathrm{e}^{-x^2} = 1-x^2+\frac{x^{4}}{2 !}+\cdots+\frac{(-x^2)^{n}}{n !}+\cdots, x \in(-∞,+∞)$
  - $\sin x  = x-\frac{x^{3}}{3 !}+\cdots+\frac{(-1)^{n} x^{2 m+1}}{(2 n+1) !}+\cdots, x \in(-∞,+∞)$
  - $\cos x  = 1-\frac{x^{2}}{2 !}+\cdots+\frac{(-1)^{*} x^{2 *}}{(2 n) !}+\cdots, x \in(-∞,+∞)$
  - $\ln (1+x)  = x-\frac{x^{2}}{2}+\cdots+\frac{(-1)^{n-1} x^{n}}{n}+\cdots, x \in(-1,1]$
  - $(1+x)^{x}  = 1+\alpha x+\frac{a(a-1)}{2 !} x^{2}+\cdots+\frac{a(a-1) \cdots(a-n+1)}{n !} x^{*}+\cdots, x \in(-1,1)$
