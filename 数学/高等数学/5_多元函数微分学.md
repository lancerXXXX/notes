  ...
  - 全微分  
    ...
    - 验证
      - 1
        ...
        - $\lim_{\Delta x\rightarrow 0\atop \Delta y\rightarrow 0}\frac{[f(x_0+\Delta x,y_0+\Delta y)-f(x_0,y_0)]-[f'_{x}(x_0,y_0)\Delta x+f'_{y}(x_0,y_0)\Delta y]}{\underbrace{\rho}_{\sqrt[]{(\Delta x)^2+(\Delta y)^2}}}=0成立$
      - 2
